...
function AdminSidebar({ open, onClose }: AdminSidebarProps) {
  ...
  return (
    <aside
      className={cn(
        'fixed top-0 z-40 flex h-screen w-64 flex-col border-[var(--glass-border)] bg-[var(--glass-bg)] backdrop-blur-2xl shadow-[var(--glass-shadow)] transition-transform duration-300',
    ...
    >
      ...
      <div className="border-t border-[hsl(var(--border))] p-4 space-y-1">
        ...
        {me && (
          <p className="pt-2 text-xs text-[hsl(var(--muted-foreground))] truncate">
