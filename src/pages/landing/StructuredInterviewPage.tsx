        ...
        <div className="relative w-full aspect-[3/4] sm:aspect-[16/10] lg:aspect-[16/7]">
          ...
          <div className="absolute inset-0 flex items-end sm:items-center justify-center px-4 sm:px-6 lg:px-8 pb-12 sm:pb-0">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold leading-tight text-white drop-shadow">راهنمای سامانه</h1>
              <p className="text-base sm:text-base text-white/90 mt-2 font-medium">مصاحبه بالینی ساختاریافته</p>
